...
def setup
    @chef = Chef.new(name:"Carlos",email:"csosa@gmail.com",password:"password",password_confirmation:"password")
end
...
test "email should be lower case before htting db" do
